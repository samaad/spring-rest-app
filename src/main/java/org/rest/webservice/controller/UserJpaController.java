...
import org.rest.webservice.dao.UserJpaDao;
...
public class UserJpaController {
  ...
  public UserJpaController(UserJpaDao userJpaDao){
  ...
  public ResponseEntity createUser(@Valid @RequestBody User user){
    User responsUser = userJpaDao.save(user);
...
//  HETEOAS Example
  @GetMapping("/{userId}")
  public EntityModel<User> retriveJpaUser(@PathVariable("userId") int userId){
    Optional<User> user = userJpaDao.findOne(userId);
    if(!user.isPresent()){
